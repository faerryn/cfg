...
#+begin_src emacs-lisp
  (with-eval-after-load "grep"
    ...
    (when (executable-find "rg")
      ...
      (grep-apply-setting
       'grep-command "rg --vimgrep -nH --null -e ")
      (grep-apply-setting
       'grep-template "rg <X> <C> --vimgrep -nH --null -e <R> <F>")
      (grep-apply-setting
       'grep-find-command "rg --vimgrep -nH --null -e ")
      (grep-apply-setting
       'grep-find-template "rg <X> <C> --vimgrep -nH --null -e <R> <D>")))
#+end_src
** Follow symlinks
#+begin_src emacs-lisp
...
#+end_src
*** diff-hl
diff-hl shows unstaged changes in a git repository.
#+begin_src emacs-lisp
