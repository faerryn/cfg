...
#+begin_src emacs-lisp
  ...
  (autoload 'evil-mode "evil" "Toggle Evil-Local mode in all buffers." t)
...
#+begin_src emacs-lisp
  ...
  (autoload
    ...
    "Register the Evil bindings for all modes in ‘evil-collection-mode-list’." t)

  (advice-add 'evil-collection-init :after
              (lambda ()
                (interactive)
...
#+begin_src emacs-lisp
  (straight-use-package
   '(webkit :type git :host github :repo "akirakyle/emacs-webkit"
            ...
            :pre-build (("make"))))
  (autoload 'webkit "webkit" "Fetch URL and render the page." t)
...
#+begin_src emacs-lisp
  ...
  (autoload 'gcmh-mode "gcmh" "Minor mode to tweak Garbage Collection strategy." t)
