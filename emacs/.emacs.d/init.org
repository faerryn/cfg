...
#+begin_src emacs-lisp
  ...
  (defun faerryn/exwm-command-switch (&ignored)
    (add-hook 'window-setup-hook #'exwm-init))
  (add-to-list 'command-switch-alist '("--exwm" . faerryn/exwm-command-switch))
    ...
    (custom-set-variables
     '(exwm-mode-map
       (let ((map (make-sparse-keymap)))
         ...
         (define-key map (kbd "C-z") #'exwm-input-toggle-keyboard)
         map))
     '(exwm-input-prefix-keys
       (list (kbd "C-c")
             ...
             (kbd "M-&")
             (kbd "M-:"))))
    (cl-pushnew (kbd "C-z") exwm-input--global-keys)
