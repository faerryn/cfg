...
#+begin_src emacs-lisp
  ...
  (define-key (current-global-map) (kbd "C-c l") #'eglot)
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load "exwm"
    ...
    (custom-set-variables
     '(exwm-mode-map
       (let ((map (make-sparse-keymap)))
         ...
         (define-key map (kbd "s-f") #'exwm-layout-toggle-fullscreen)
    ...
    (defun faerryn/exwm-unfullscreen (&rest _)
      (exwm-layout-unset-fullscreen))
    (defun faerryn/exwm-init-hook ()
      (add-hook 'faerryn/before-minibuffer-hook #'faerryn/exwm-unfullscreen)
      (add-hook 'window-size-change-functions #'faerryn/exwm-unfullscreen))
    ...
    (defun faerryn/exwm-exit-hook ()
      ...
      (remove-hook 'window-size-change-functions #'faerryn/exwm-unfullscreen))
