...
This makes EXWM fullscreen respect the same bindings as normal.
#+begin_src emacs-lisp
  (defun faerryn/exwm-keep-input-mode (&optional id)
    (when-let ((id (or id (exwm--buffer->id (current-buffer)))))
      (exwm-input--grab-keyboard id)))
  (advice-add #'exwm-layout-set-fullscreen :after #'faerryn/exwm-keep-input-mode)
#+end_src
