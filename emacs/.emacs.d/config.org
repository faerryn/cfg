...
Enable a custom global minor-mode for rainbow-mode and enable it.
#+begin_src emacs-lisp
  (require 'rainbow-mode)
  (define-globalized-minor-mode faerryn/global-rainbow-mode rainbow-mode rainbow-turn-on)
  (faerryn/global-rainbow-mode +1)
#+end_src
** Show Paren
...
This sets up custom default lsp servers.
#+begin_src emacs-lisp
  (with-eval-after-load "eglot"
...
#+end_src
** Snippets
This sets up snippet support through yasnippet.
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  ...
  (autoload 'caml-mode "caml-mode" "Major mode for editing OCaml code." t)
...
#+end_src
** PDF
Emacs' DocView is not very good. Pdf-tools provides PDFView, a
...
This defines keybindings and key behaviors for EXWM.
#+begin_src emacs-lisp
