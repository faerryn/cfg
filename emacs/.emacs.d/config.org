...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load "consult"
    (add-to-list 'consult-buffer-filter (rx string-start "*Backtrace*" string-end))
    (add-to-list 'consult-buffer-filter (rx string-start "*Help*" string-end))
    (add-to-list 'consult-buffer-filter (rx string-start "*Messages*" string-end))
