...
Emacs' default modeline is ugly. Doom Emacs provides us with an
aesthetic alternative.

The reason we are autoloading `doom-modeline' is to ensure that a
frame exists when the code is loaded. Otherwise, some features will be
disabled by default.
#+begin_src emacs-lisp
...
#+end_src
** Theme
Emacs' default theme is blindingly bright. Doom Emacs (once again) provides an aesthetic alternative.
#+begin_src emacs-lisp
